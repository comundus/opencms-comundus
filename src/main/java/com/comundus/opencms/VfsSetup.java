...
public class VfsSetup {
    ...
    final CmsImportExportManager iomanager*/) throws Exception {
        ...
        // this is not in the original openCms setup,
        // but we need it for the new way of syncing the original modules
        ...
        cmsobject.chacc("/system", "role", "WORKPLACE_USER", "+v+r+i");
