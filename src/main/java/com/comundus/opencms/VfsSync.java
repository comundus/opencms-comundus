    ...
    */
    ...
    private CmsResource readResourcesFromManifest(final byte[] content)
        ...
        try {
            ...
            // <destination>
            destination = CmsImport.getChildElementTextValue(currentElement,
                    CmsImportExportManager.N_DESTINATION);

            // <type>
            final String typeName = CmsImport.getChildElementTextValue(currentElement,
                    CmsImportExportManager.N_TYPE);
            final I_CmsResourceType type = OpenCms.getResourceManager()
                                                  .getResourceType(typeName);

            // <uuidstructure>
            uuidstructure = CmsImport.getChildElementTextValue(currentElement,
                    CmsImportExportManager.N_UUIDSTRUCTURE);

            // <uuidresource>
            if (!type.isFolder()) {
                uuidresource = CmsImport.getChildElementTextValue(currentElement,
            ...
            // <datelastmodified>
            timestamp = CmsImport.getChildElementTextValue(currentElement,
            ...
            // <userlastmodified>
            userlastmodified = CmsImport.getChildElementTextValue(currentElement,
            ...
            // <usercreated>
            usercreated = CmsImport.getChildElementTextValue(currentElement,
            ...
            // <flags>              
            flags = CmsImport.getChildElementTextValue(currentElement,
            ...
            if (resourceNotImmutable) {
                ...
                if (res == null) {
                    ...
                    for (int j = 0; j < acentryNodes.size(); j++) {
                        ...
                        final String id = CmsImport.getChildElementTextValue(currentEntry,
                        ...
                        try {
                            ...
                            final String acflags = CmsImport.getChildElementTextValue(currentEntry,
                                    CmsImportExportManager.N_FLAGS);
    ...
    protected void importRelations(final CmsResource resource,
        ...
        while (itRelations.hasNext()) {
            ...
            final String structureID = CmsImport.getChildElementTextValue(relationElement,
                    CmsImportExportManager.N_RELATION_ATTRIBUTE_ID);
            final String targetPath = CmsImport.getChildElementTextValue(relationElement,
                    CmsImportExportManager.N_RELATION_ATTRIBUTE_PATH);
            final String relationType = CmsImport.getChildElementTextValue(relationElement,
    ...
    private List readPropertiesFromManifest(final Element parentElement,
        ...
        for (int i = 0, n = propertyElements.size(); i < n; i++) {
            ...
            key = CmsImport.getChildElementTextValue(propertyElement,
            ...
            value = CmsImport.getChildElementTextValue(propertyElement,
