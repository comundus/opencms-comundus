...
public class CmsVfsConfiguration extends A_CmsXmlConfiguration implements I_CmsXmlConfiguration {
     ...
     * The "relationtype defined in content" attribute name. */
    public static final String A_DEFINCONTENT = "defincontent";
    ...
    public void addXmlDigesterRules(Digester digester) {
        ...
        // ADDED BY COMUNDUS : the defincontent parameter - OpenCms Sprint : change integrated into 7.0.5 code
        digester.addCallMethod(
