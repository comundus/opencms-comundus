...
public final class CmsRelationType implements Serializable {
    ...
    public CmsRelationType(int id, String name, String type) {
        ...
        // CHANGED BY COMUNDUS
        m_defInContent = true;	// false;
        m_id = USER_DEFINED_MODE_LIMIT + id;
    }

    /** ADDED BY COMUNDUS  - OpenCms Sprint : change integrated into 7.0.5 code
     * Public constructor for user defined relation types with parameter wether link is defined in content.<p>
     * 
     * @param id the id of the relation type
     * @param name the name of the relation
     * @param type the type of relation type, strong or weak
     ...
     */
    public CmsRelationType(int id, String name, String type, boolean defInContent) {
    ...
    public static CmsRelationType valueOf(int id) throws CmsIllegalArgumentException {
        ...
        // BUG FIXED BY COMUNDUS - OpenCms Sprint : change integrated into 7.0.5 code
    ...
    private static CmsRelationType valueOfInternal(String name) {
        ...
        if (name != null) {
        	...
        	// BUG FIX BY COMUNDUS - OpenCms Sprint : has been fixed by Alkacon already in 7.0.5
        	CmsRelationType type = (CmsRelationType)getAllUserDefined().get(i);
                if (valueUp.equals(type.m_name)) {
                    return type;	// wrong by Alkacon: VALUE_ARRAY[i];
                }
            }
        }
        return null;
