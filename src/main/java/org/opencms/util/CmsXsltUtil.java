/*
 * File   : $Source: /usr/local/cvs/opencms/src/org/opencms/util/CmsXsltUtil.java,v $
...
public final class CmsXsltUtil {
    ...
    private static String getTableHtml(String csvData, String delimiter) throws IOException {
        ...
        // BUGFIX BY COMUNDUS - OpenCms Sprint : change integrated into 7.0.5 code
        //String formatString = csvData.substring(0, csvData.indexOf(lineSeparator));
        int tmpindex = csvData.indexOf(lineSeparator);
        if (tmpindex == -1) tmpindex = csvData.length();
        	
        String formatString = csvData.substring(0, tmpindex);
