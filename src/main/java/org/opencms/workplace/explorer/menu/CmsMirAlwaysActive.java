/*
 * File   : $Source: /usr/local/cvs/opencms/src/org/opencms/workplace/explorer/menu/CmsMirAlwaysActive.java,v $
...
/**
 * Defines a menu item rule that sets the visibility to active for all possible project and resource states.<p>
 * 
 ...
 * @since 6.5.6
 */
public class CmsMirAlwaysActive extends A_CmsMenuItemRule {
