/*
 * File   : $Source: /usr/local/cvs/opencms/src/org/opencms/workplace/explorer/menu/CmsMirPrOnlineActive.java,v $
...
/**
 * Defines a menu item rule that sets the visibility to active if the current project is the Online project.<p>
 * 
 ...
 * @since 6.5.6
 */
public class CmsMirPrOnlineActive extends A_CmsMenuItemRule {
