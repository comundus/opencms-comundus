/*
 * File   : $Source: /usr/local/cvs/opencms/src/org/opencms/workplace/explorer/menu/CmsMirPrOtherInactive.java,v $
...
/**
 * Defines a menu item rule that sets the visibility to inactive if the resource is not part of the current project.<p>
 * 
 ...
 * @since 6.5.6
 */
public class CmsMirPrOtherInactive extends A_CmsMenuItemRule {
    ...
    public CmsMenuItemVisibilityMode getVisibility(CmsObject cms, CmsResourceUtil[] resourceUtil) {
        ...
        return CmsMenuItemVisibilityMode.VISIBILITY_INACTIVE.addMessageKey(Messages.GUI_CONTEXTMENU_TITLE_INACTIVE_OTHERPROJECT_0);
    }
