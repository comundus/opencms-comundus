...
/**
 * Defines a menu item rule that sets the visibility to invisible if the resource is not part of the current project.<p>
 * 
 ...
 * @since 6.5.6
 */
public class CmsMirPrOtherInvisible extends A_CmsMenuItemRule {
