/*
 * File   : $Source: /usr/local/cvs/opencms/src/org/opencms/workplace/explorer/menu/CmsMirPrSameOtherlockActive.java,v $
 ...
 * @since 6.5.6
 */
public class CmsMirPrSameOtherlockActive extends A_CmsMenuItemRule {
