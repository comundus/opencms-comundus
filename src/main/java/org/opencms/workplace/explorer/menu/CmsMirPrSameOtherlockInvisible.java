/*
 * File   : $Source: /usr/local/cvs/opencms/src/org/opencms/workplace/explorer/menu/CmsMirPrSameOtherlockInvisible.java,v $
 ...
 * if the current resource is not exclusively locked by the current user.<p>
 * 
 ...
 * @since 6.5.6
 */
public class CmsMirPrSameOtherlockInvisible extends A_CmsMenuItemRule {
